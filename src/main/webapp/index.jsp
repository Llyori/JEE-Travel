                    ...
                    <div class="nk-block nk-block-middle nk-auth-body  wide-xs">
                        ...
                        <div class="card card-bordered">
                            <div class="card-inner card-inner-lg">
                                ...
                                <form action="#" method="post">
                                    ...
                                    <div class="form-group">
                                        <div class="form-label-group">
                                            ...
                                            <a class="link link-primary link-sm" name="passcode" href="html/pages/auths/auth-reset-v2.html">Code Oublié?</a>
                                        </div>
                                        <div class="form-control-wrap">
                                ...
                                <div class="form-note-s2 text-center pt-4"> Nouveau Sur la PLateforme? <a href="html/pages/auths/auth-register-v2.html">Créer un compte</a>
                                </div>
                                ...
                                <ul class="nav justify-center gx-4">
                                    ...
                                    <li class="nav-item"><a class="nav-link" href="#">Twiter</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
