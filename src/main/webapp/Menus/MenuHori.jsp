                                        ...
                                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                            <div class="user-toggle">
                                                ...
                                                <div class="user-info d-none d-md-block">
                                                    <div class="user-status"><% out.println(LogIn.user.getRole().getNomRole().toUpperCase()); %></div>
                                                    <div class="user-name dropdown-indicator"><% out.println(LogIn.user.getNom()); %></div>
                                                </div>
                                            </div>
                                        </a>
                                            ...
                                            <div class="dropdown-inner user-card-wrap bg-lighter d-none d-md-block">
                                                <div class="user-card">
                                                    ...
                                                    <div class="user-info">
                                                        ...
                                                        <span class="sub-text"><% out.println(LogIn.user.getEmail()); %></span>
                                                    </div>
                                                </div>
                                            </div>
