                        ...
                        <div class="nk-sidebar-content">
                            ...
                            <div class="nk-sidebar-widget d-none d-xl-block">
                                <ul class="user-account-data gy-1">
                                    <li>
                                        <div class="user-account-label">
                                            <span class="sub-text">Voitures Disponibles</span>
                                        </div>
                                        <div class="user-account-value">
                                            <span class="lead-text">+ 0.0526 <span class="currency currency-btc">BTC</span></span>
                                            <span class="text-success ml-2">3.1% <em class="icon ni ni-arrow-long-up"></em></span>
                                    ...
                                    <li>
                                        <div class="user-account-label">
                                            <span class="sub-text">Réservations</span>
                                        </div>
                                        <div class="user-account-value">
                                            <span class="lead-text">+ 0.0526 <span class="currency currency-btc">BTC</span></span>
                                            <span class="text-danger ml-2">1.1% <em class="icon ni ni-arrow-long-down"></em></span>
                                        </div>
                                    </li>
                                </ul>
